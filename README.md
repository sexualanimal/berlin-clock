...
The Berlin Uhr (Clock) is a rather strange way to show the ATime. On the top of the clock there is a yellow lamp that
blinks on/off every two seconds. The ATime is calculated by adding rectangular lamps.
